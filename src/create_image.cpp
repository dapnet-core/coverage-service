...
QImage (0,0)->xxxxxxxxxxxxxxxxxxxxxxx
    ...
    QString help123 = myValues->path_to_image + myValues->name + " " +
                      QDate::currentDate().toString("ddMMyy").toStdString().c_str() + "_" +
                      QTime::currentTime().toString("hh:mm").toStdString().c_str() + ".png";
